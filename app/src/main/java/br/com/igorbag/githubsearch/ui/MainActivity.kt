...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        btnConfirmar.setOnClickListener{
            val dataNomeUsuario = nomeUsuario.text.toString()
            saveUserLocal(dataNomeUsuario)
            Toast.makeText(this, "Usuário $dataNomeUsuario foi salvo e estamos buscando seus repositórios", Toast.LENGTH_SHORT).show()
